...
public class Grid implements IGameObject {
            ...
            private void drawEndGameOverlay(Graphics2D graphicsRender) {
                        ...
                        if(winType == -1) {
                                    // tie!
                                    graphicsRender.drawString("Empate.",  205, 235);
                        } else {
                                    // won!
                                    graphicsRender.drawString((winType == 0 ? "X" : "O") + " venceu.",  190, 235);
                        }

                        graphicsRender.drawString("Clique em qualquer lugar pare reiniciar.",  15, 260);
